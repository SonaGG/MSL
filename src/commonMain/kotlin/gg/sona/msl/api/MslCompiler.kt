    ...
    fun compileSpirv(
        ...
        try {
            ...
            if (module != null) {
                ...
                Optimizer(optimization, isNative, diagnostics, specialization).run(module)
    ...
    fun compileDxil(
        ...
        try {
            ...
            if (module != null) {
                ...
                Optimizer(optimization, DxilNativeIntrinsics::isNative, diagnostics, specialization).run(module)
                for (entry in module.entryPoints) {
